...
The structure of this repo is one general directory of the folder, "testrep" and two subdirectory, "+mypkg" and "mypkg" 
the code package "+mypkg" consist code in matlab and the code package "mypkg" consist codes in python.
